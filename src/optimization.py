...
def get_optimizer(
    ...
    if optimizer.lower() == "sgd":
        ...
        # and weight_decay
        opt = torch.optim.SGD(model.parameters(), learning_rate ,momentum=0.123, weight_decay=0.123
            # YOUR CODE HERE
        )
        ...
        # optimizer. Use the input parameters learning_rate, momentum
        # and weight_decay
        opt = torch.optim.Adam(model.parameters(), learning_rate, weight_decay=0.123
        # YOUR CODE HERE
        )
    else:
